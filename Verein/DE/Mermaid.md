...
graph TD
    ...
    style A1 fill:#E0F7FA,stroke:#00796B
    style A2 fill:#E0F7FA,stroke:#00796B
    style A3 fill:#E0F7FA,stroke:#00796B
    style A4 fill:#E0F7FA,stroke:#00796B
    style A5 fill:#E0F7FA,stroke:#00796B
    ...
    style C1 fill:#FCE4EC,stroke:#D81B60
    style C2 fill:#FCE4EC,stroke:#D81B60
    style C3 fill:#FCE4EC,stroke:#D81B60
    style C4 fill:#FCE4EC,stroke:#D81B60
    style C5 fill:#FCE4EC,stroke:#D81B60
```